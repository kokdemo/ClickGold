...
var vm = new Vue({
        ...
        data: {
            ...
            population: {
                all: {storage: 0, maxStorage: 20, addSpeed: 0,
                    cost: {wood: 10, food: 0, stone: 0, clothes: 0, medicine: 0, metal: 0, gold: 0, happy: 0, territory: 0}
                },
                consume: {cost: {wood: 0, food: 1, stone: 0, clothes: 0, medicine: 0, metal: 0, gold: 0, happy: 0, territory: 0}}
...
var cm = {
    ...
    liquidateResource: function () {
        var temp = vm.$data;
        var popObject = temp.population.all;
            setInterval(function () {
                var checkSub = cm.subtractResource(temp.population.consume, popObject.storage);
            }, 1000);
    }
};
$(document).ready(function(){
    cm.liquidateResource();
});